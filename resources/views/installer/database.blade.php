...
<form method="post" action="{{ route('install.database') }}" class="bg-white rounded-3xl p-6 md:p-10 shadow-2xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="md:col-span-3 mb-4">
            ...
            <select name="db_connection" id="db_connection" class="w-full rounded-xl border border-indigo-500 p-3 bg-indigo-50 font-semibold text-indigo-700 transition duration-150">
        ...
        <div id="connection-fields" class="md:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
                ...
                <input name="db_host" id="db_host" class="w-full rounded-xl border border-gray-300 p-3 focus:ring-indigo-500 focus:border-indigo-500" value="127.0.0.1" placeholder="مثال: localhost">
            </div>
            ...
            <div>
                ...
                <input name="db_port" id="db_port" type="number" class="w-full rounded-xl border border-gray-300 p-3 focus:ring-indigo-500 focus:border-indigo-500" value="3306" placeholder="مثال: 5432">
            </div>
            ...
            <div>
                ...
                <input name="db_database" id="db_database" class="w-full rounded-xl border border-gray-300 p-3 focus:ring-indigo-500 focus:border-indigo-500" placeholder="مثال: gardon_db">
            </div>
            ...
            <div>
                ...
                <input name="db_username" id="db_username" class="w-full rounded-xl border border-gray-300 p-3 focus:ring-indigo-500 focus:border-indigo-500" placeholder="مثال: root">
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <input name="db_password" id="db_password" type="password" class="w-full rounded-xl border border-gray-300 p-3 focus:ring-indigo-500 focus:border-indigo-500">
            </div>
